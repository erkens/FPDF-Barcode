...
class Code39
{
     ...
     */
    function drawCode($x, $y, $code, $extendedEncoding = true, $addChecksum = false, $width= 0.4, $height = 20., $wide = true, $displayText = false)
    {
        if ($displayText) {
            //Display code
            $this->fpdf->SetFont('Arial', '', 10);
            $this->fpdf->SetXY($x, $y + $height);
            $this->fpdf->Cell(120, 5, '* '.$code.' *', 0, 0, 'C');
        }
        ...
        //Draw bars
        $this->draw_code39($encode, $x, $y, $width, $height);
    }
